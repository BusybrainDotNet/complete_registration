...
?>
<title>Authentication | Live Chat System | Messaging </title>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 detailed">
                       <form class="form-login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                          <p class="text-center" style="color: indianred; font-weight: bold;">** Enter 2FA Digits **</p>
                          <h2 class="form-login-heading">Verify | Authenticate</h2>
                          <div class="login-wrap">
                            ...
                            <input type="hidden" class="form-control" name="user" value="<?php echo $_GET['u'] ?>">
                            <input type="number" class="form-control" name="code" placeholder="6 Digits Unlock Key" required autofocus>
                            <br>
                            <button class="btn btn-theme btn-block" type="submit" name="verify"><i class="fa fa-unlock"></i> Unlock</button>
                          </div>
                        </form>
                      </div>
                  <!-- /row -->

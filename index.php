...
<title>Welcome | Join Us | Messaging | Community </title>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 detailed">
                  <form class="form-login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                      ...
                      <h2 class="form-login-heading">Register | Join Us</h2>
                      ...
                      <div class="login-wrap">
                        ...
                        <br><br>
                        <button class="btn btn-theme btn-block" name="join" type="submit"><i class="fa fa-user"></i> Register</button>
                      </div>
                    </form>
                  </div>
                  <!-- /row -->
